...
@PluginDescriptor(
	name = "Bank Diff",
	description = "See your bank progress from a certain point in time",
...
public class BankDiffPlugin extends Plugin
{
	...
	private MenuEntry createEntry(String option, MenuEntryAdded event)
	{
		...
		entry.setParam0(event.getParam0());
	...
	public void onMenuOptionClicked(MenuOptionClicked event)
	{
		...
		if (event.getOption().equals(CREATE_SNAPSHOT))
		{
		...
		else if (event.getOption().equals(TOGGLE_VIEW))
		{
