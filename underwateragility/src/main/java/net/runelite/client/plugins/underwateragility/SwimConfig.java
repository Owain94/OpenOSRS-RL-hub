...
public interface SwimConfig extends Config
{
	...
	default boolean isDistanceShown()
	{
		return false;
	}
	...
	default CompassDirections compassDirections()
	{
		return CompassDirections._8;
	}
	...
	default boolean isAdjacentBubbleShown()
	{
		return true;
	}
}
