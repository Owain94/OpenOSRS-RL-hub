package net.runelite.client.plugins.raidtracker.ui;
...
import net.runelite.client.plugins.raidtracker.RaidTrackerConfig;
import net.runelite.client.plugins.raidtracker.RaidTrackerItem;
import net.runelite.client.plugins.raidtracker.filereadwriter.FileReadWriter;
...
public class RaidTrackerPanel extends PluginPanel
{
	...
	{
		update.setEnabled(b);
		update.setBackground(ColorScheme.BRAND_BLUE);
	...
	public Future<Map<Integer, RaidTrackerItem>> getDistinctRegularDrops()
	{
		...
		clientThread.invoke(() -> {
			...
			if (loaded)
			{
				...
				{
					ItemDefinition IC = itemManager.getItemDefinition(i);
