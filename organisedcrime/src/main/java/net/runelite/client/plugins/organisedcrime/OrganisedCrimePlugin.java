package net.runelite.client.plugins.organisedcrime;
...
import net.runelite.client.plugins.organisedcrime.tools.InformationBoardTextReader;
import net.runelite.client.plugins.organisedcrime.tools.ViewStateMapper;
import static net.runelite.client.plugins.organisedcrime.tools.WidgetConstants.GROUP_ID_INFORMATION_BOARD;
import static net.runelite.client.plugins.organisedcrime.tools.WidgetConstants.GROUP_ID_NO_INFORMATION_ATM;
import net.runelite.client.plugins.organisedcrime.ui.LocationViewState;
import net.runelite.client.plugins.organisedcrime.ui.OrganisedCrimePanel;
...
public class OrganisedCrimePlugin extends Plugin
{
	...
	{
		if (widgetLoaded.getGroupId() != GROUP_ID_INFORMATION_BOARD)
		{
			return;
		}
