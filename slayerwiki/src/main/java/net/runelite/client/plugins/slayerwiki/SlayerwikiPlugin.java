package net.runelite.client.plugins.slayerwiki;
...
public class SlayerwikiPlugin extends Plugin
{
	...
	private final static Set<String> SLAYER_ITEMS = Set.of(SLAYER_HELMET, SLAYER_RING, ETERNAL_GEM, ENCHANTED_GEM, BLACK_MASK);
