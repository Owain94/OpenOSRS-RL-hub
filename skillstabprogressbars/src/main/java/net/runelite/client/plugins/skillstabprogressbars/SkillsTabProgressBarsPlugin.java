...
{
	static final Map<Skill, Double> progressToLevelNormalised = new HashMap<>();
	static final Map<Skill, Double> progressToGoalNormalised = new HashMap<>();
	...
	private void calculateAndStoreProgressToLevel(Skill skill, int currentXp)
	{
		...
		SkillsTabProgressBarsPlugin.progressToLevelNormalised.put(skill, progressToLevelNormalised);
	}
	...
	private void calculateAndStoreProgressToGoal(Skill skill, int currentXp)
	{
		...
		SkillsTabProgressBarsPlugin.progressToGoalNormalised.put(skill, progressToGoalNormalised);
	}
	...
	static Skill skillFromWidgetID(int widgetID)
	{
	...
	private static VarPlayer getStartGoalVarPlayer(Skill skill)
	{
		switch (skill)
		{
			case ATTACK:
	...
	private static VarPlayer getEndGoalVarPlayer(Skill skill)
	{
		switch (skill)
		{
			case ATTACK:
