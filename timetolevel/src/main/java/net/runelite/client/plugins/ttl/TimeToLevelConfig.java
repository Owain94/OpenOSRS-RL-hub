...
import static net.runelite.client.plugins.ttl.TimeToLevelConfig.CONFIG_GROUP;
...
public interface TimeToLevelConfig extends Config
{
	...
	String DEFAULT_BUYABLES = "cooking,smithing,fletching,firemaking,herblore,crafting,construction,prayer,ranged,magic,farming";
