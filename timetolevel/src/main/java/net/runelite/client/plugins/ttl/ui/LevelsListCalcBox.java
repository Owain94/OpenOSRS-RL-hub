...
import net.runelite.client.plugins.ttl.ImgUtils;
import net.runelite.client.plugins.ttl.RateTTL;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.LEVEL_COLUMN_WIDTH;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.SKILL_COLUMN_HEIGHT;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.SKILL_COLUMN_WIDTH;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.TTL_COLUMN_WIDTH;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.XP_COLUMN_WIDTH;
import static net.runelite.client.plugins.ttl.ui.LevelsListPanel.XP_RATE_COLUMN_WIDTH;
